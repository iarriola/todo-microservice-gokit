...
import (
	...
	endpoint "github.com/iarriola/todo-microservice-gokit/tasks/pkg/endpoint"
	http "github.com/iarriola/todo-microservice-gokit/tasks/pkg/http"
...
var fs = flag.NewFlagSet("tasks", flag.ExitOnError)
